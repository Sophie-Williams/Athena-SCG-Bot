...
access, our flags library GFlags (located at 
\url{http://code.google.com/p/google-gflags/}), automatically generates command
line documentation for all the flags defined. This removes yet another tedious
development step.
